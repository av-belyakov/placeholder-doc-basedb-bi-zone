...
// SupportiveDataSecurityType вспомогательный тип для обработки 'data.data_security'
type SupportiveDataSecurityType struct {
	currentKey         string
...
// NewSupportiveDataSecurityType формирует вспомогательный объект для обработки объектов типа 'data.data_security'
func NewSupportiveDataSecurityType() *SupportiveDataSecurityType {
	return &SupportiveDataSecurityType{
...
func (ds *SupportiveDataSecurityType) GetDataSecurity() map[string][]datamodels.BiZoneIRPDataSecurity {
	if ds.currentKey != "" {
...
func (ds *SupportiveDataSecurityType) GetDataSecurityTmp() *datamodels.BiZoneIRPDataSecurity {
	return &ds.dataSecurityTmp
}

// HandlerValue функция обработчик значений
func (ds *SupportiveDataSecurityType) HandlerValue(fieldBranch string, a any, f func(any) error) error {
...
func (ds *SupportiveDataSecurityType) isExistFieldBranch(v string) bool {
